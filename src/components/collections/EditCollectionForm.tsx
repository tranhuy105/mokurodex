...
export function EditCollectionForm({
  ...
  const handleSearch = async () => {
    ...
    try {
      const allManga = await getAllMangaWithUserData();
                ...
                {searchResults.length > 0 ? (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-60 overflow-y-auto pr-2">
                    {searchResults.map((manga) => (
                      <div
                        key={manga.id}
                        className="flex items-center gap-3 p-2 border border-gray-200 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800"
                      >
                        {manga.coverImage && (
                        ...
                        <button
                          ...
                          className="p-1 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-full hover:bg-green-200 dark:hover:bg-green-800/40"
                        >
            ...
            {currentManga.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {currentManga.map((manga) => (
                  <div
                    key={manga.id}
                    className="flex items-center gap-3 p-3 border border-gray-200 dark:border-gray-700 rounded-md bg-white dark:bg-gray-800"
                  >
                    {manga.coverImage && (
                    ...
                    <button
                      ...
                      className="p-1 bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 rounded-full hover:bg-red-200 dark:hover:bg-red-800/40"
                    >
                      <X className="h-4 w-4" />
              ...
              <p className="text-gray-500 dark:text-gray-400 text-center py-4 border border-dashed border-gray-200 dark:border-gray-700 rounded-md">
