import { getUserMangaMetadata } from "@/actions/manga-management-prisma";
          ...
          >
            {!contentReady ? (
              ...
              <>
                ...
                {isNsfw && (
                  <div className="hidden md:block absolute top-3 right-3 bg-purple-600 text-white px-2.5 py-1 rounded-md text-sm font-bold shadow-md z-30">
                    NSFW
                  </div>
                )}
