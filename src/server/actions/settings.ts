        ...
        if (!existingSettings) {
            ...
            const newSettings = await db.settings.create({
                data: {
                    ...
                    readingMode:
                        input.readingMode ?? "singlePage",
                    animatePageTurns:
                        input.animatePageTurns ?? true,
                    highlightColor:
                        input.highlightColor ?? "#FFD700",
                    readerBackground:
                        input.readerBackground ?? "#FFFFFF",
                    pageMargin: input.pageMargin ?? 20,
                    furiganaDisplay:
                        input.furiganaDisplay ?? "hover",
                    autoSavePosition:
                        input.autoSavePosition ?? true,
                    dictionaryProvider:
                        input.dictionaryProvider ?? "jisho",
                    customDictionaryUrl:
                        input.customDictionaryUrl ?? null,
                    pageNavigationMethod:
                        input.pageNavigationMethod ??
                        "click",
                    updatedAt: now,
                },
            });
            ...
            const updatedSettings =
                await db.settings.update({
                    ...
                    data: {
                        ...
                        animatePageTurns:
                            input.animatePageTurns,
                        highlightColor:
                            input.highlightColor,
                        readerBackground:
                            input.readerBackground,
                        pageMargin: input.pageMargin,
                        furiganaDisplay:
                            input.furiganaDisplay,
                        autoSavePosition:
                            input.autoSavePosition,
                        dictionaryProvider:
                            input.dictionaryProvider,
                        customDictionaryUrl:
                            input.customDictionaryUrl,
                        pageNavigationMethod:
                            input.pageNavigationMethod,
                        updatedAt: now,
                    },
